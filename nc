...
local ThunderImageUI = Instance.new("ImageLabel")
        ...
        ThunderToggleUI.BorderSizePixel = 
        ...
        ThunderImageUI.Image = "http://www.roblox.com/asset/?id=12986011583"
...
function Update:Window(text,logo,keybind)
	local uihide = false
	local abc = false
	local logo = logo or 12986011583
	local currentpage = ""
...
Logo.Image = "rbxassetid://12986011583"
...
local postog12 = Instance.new("UIStroke")
 ...
 ImageLabel.Image = "rbxassetid://12986011583"
...
--------------------------------------------------------------------
local Library = Update:Window("FTS X HUB ","")
------------------------------------------
...
spawn(function()
 ...
 Setting:Toggle("Black Screen",false,function(value)
...
wait(1)
Notification:Notify(
   {Title = "MADOX HUB", Description = "You Have Max Observation"},
...
local Boats = Race:Dropdown("Selected Boats",BoatsName,function(plys)
  _G.SelectB = plys
end)
    
Race:Button("Refrsh Boats",function()
  BoatsName = {}
  Boats:Clear()
  for i,v in pairs(game:GetService("Workspace").Boats:GetChildren()) do  
     Boats:Add(v.Name)
...
Race:Button("Bring Boats",function()
...
Race:Toggle("Teleport to Boats",_G.TPB,function(bool)
   _G.TPB = bool       
 StopTween(_G.TPB)
...
Race:Toggle("Teleport To Gear",function()
...
Race:Seperator("Auto Complete Trial")
  
  Race:Button("Auto Complete Angel Trial",function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Map.SkyTrial.Model.FinishPart.CFrame
  end)
  
  Race:Button("Auto Complete Rabbit Trial",function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Map.MinkTrial.Ceiling.CFrame * CFrame.new(0,-5,0)
  ...
  Race:Toggle("Auto Complete Cyborg Trial",function()
...
Teleport:Seperator(" WORLD ")
 ...
 Teleport:Toggle("Teleport",false,function(value)
  ...
  topos(CFrame.new(-1151.48987, 16.1422901, -14445.6904, -0.316594511, -6.85698254e-08, -0.948560953, -2.05343067e-08, 1, -6.54346692e-08, 0.948560953, -1.23821675e-09, -0.316594511))
  end
 ...
 Teleport:Button("TP bypass Island",function()
		 _G.Instant = true
        ...
        game.Players.LocalPlayer.Character.Head:Destroy()
        wait(0.5)
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1151.48987, 16.1422901, -14445.6904, -0.316594511, -6.85698254e-08, -0.948560953, -2.05343067e-08, 1, -6.54346692e-08, 0.948560953, -1.23821675e-09, -0.316594511)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetSpawnPoint")
        until game:GetService("Players").LocalPlayer.Data.SpawnPoint.Value == SPAWNPOINT 
        ----------------------------------------------------------------------------------------------------
        elseif _G.SelectIsland == "The Cafe" then
